...
pdf_endpoints_code = '''from fastapi import APIRouter, File, UploadFile, Form, Depends, Request
...
async def compress_pdf(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(compressed, out_name, owner_id=user_id)
...
async def merge_pdfs(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(merged, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def split_pdf(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(out_bytes, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def images_to_pdf(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(converted, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def watermark_pdf(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(watermarked, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def organize_pdf(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(organized, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def delete_pdf_pages(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(modified, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def extract_pdf_pages(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(extracted, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def rotate_pdf(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(rotated, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def add_page_numbers(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(numbered, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def crop_pdf(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(cropped, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def pdf_to_word(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(docx_bytes, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def pdf_to_excel(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(xlsx_bytes, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def pdf_to_pptx(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(pptx_bytes, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def pdf_to_txt(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(txt_bytes, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def pdf_to_html(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(html_bytes, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def pdf_to_pdfa(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(pdfa_bytes, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def word_to_pdf(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(pdf_bytes, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def protect_pdf(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(protected, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def unlock_pdf(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(unlocked, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def encrypt_pdf(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(encrypted, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def redact_pdf(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(redacted, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def remove_metadata(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(cleaned, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def edit_pdf(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(edited, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def add_image_to_pdf(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(stamped, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def add_links(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(linked, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def highlight_pdf(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(highlighted, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def annotate_pdf(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(annotated, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def resize_pages(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(resized, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def ocr_pdf(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(ocr_bytes, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def pdf_to_markdown(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(md_bytes, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def repair_pdf(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(repaired, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def compare_pdfs(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(compared, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def flatten_pdf(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(flattened, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def deskew_pdf(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(deskewed, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def extract_images(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(zip_bytes, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def overlay_pdf(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(overlaid, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def pdf_bookmarks(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(result, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
async def metadata_editor(
    ...
    try:
        ...
        result_id, _ = save_result_buffer(updated, out_name, owner_id=user_id)
        JobService.complete_job(db, job.id, result_id)
...
with open(r"d:\Download\NextGen-PDF-Launch-Ready-V1\nextgen\backend\app\api\v1\endpoints\pdf.py", "w", encoding="utf-8") as f:
    f.write(pdf_endpoints_code)

print("backend/app/api/v1/endpoints/pdf.py successfully written with all 48 PDF tool endpoints.")
